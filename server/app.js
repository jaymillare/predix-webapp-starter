...
if (!config.isUaaConfigured()) {
  ...
  console.log('D I R N A M E : ', __dirname + '/dist/rosegardenui');
  console.log('B A S E D I R : ', process.env['base-dir']);  
...
var oxygenTimeSeriesRoutes = require('./routes/oxygen-time-series.js');
...
//app.use(['/api/predix-timeseries'], oxygenTimeSeriesRoutes); 
